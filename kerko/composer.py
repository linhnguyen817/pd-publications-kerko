...
class Composer:
    ...
    def __init__(
            ...
            *,
            ...
            default_child_blacklist_re=r'^_',
            mime_types=None,
        ...
        :param str default_child_whitelist_re: Regex to use to whitelist
            ...
            unless the `default_child_blacklist_re` argument is set and causes
            some to be rejected.

        :param str default_child_blacklist_re: Regex to use to blacklist
            children (e.g. notes, attachments) based on their tags. Any child
            ...
            `default_child_whitelist_re` argument is set and the tags of those
        ...
        self.default_child_blacklist_re = default_child_blacklist_re
            ...
            self.add_field(
                FieldSpec(
                    ...
                    extractor=extractors.NotesTextExtractor(
                        whitelist_re=self.default_child_whitelist_re,
                        blacklist_re=self.default_child_blacklist_re
                    )
                )
            )
